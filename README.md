...
| `npm test` | 196-assertion workflow suite against a fresh, isolated database |
...
Builds a fresh database and runs 196 assertions across authentication, role permissions,
